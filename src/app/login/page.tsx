  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black flex items-center justify-center">
      <div className="bg-white dark:bg-zinc-800 p-8 rounded shadow-md w-full max-w-md">
        <h1 className="text-3xl font-semibold text-black dark:text-zinc-50 mb-6">Login</h1>
        ...
        <p className="mt-4 text-sm text-zinc-600 dark:text-zinc-400">
          Vous n&apos;avez pas de compte ? <a href="/register" className="text-blue-500">S&apos;inscrire</a>
        </p>
      </div>
    </div>
  );
